...
class LiliBot(commands.Bot):
    ...
    async def setup_hook(self):
        LILI_COMMANDS = {
            ...
            "turn_off": "うわぁ………", "sad": "ひどいよー", "happy": "やったー！", "angry": "もう知らない！",
            "feel_shy": "えへへ…", "surprised": "キャー！", "sorry": "ごめんなさい…", "smile": "うふふ～～",
...
async def on_message(message):
    ...
    if message.author.id == NANA_USER_ID:
        responses = {
            ...
            "約束": "こんな物語をわわすれるくらいなら～", "大人のオの字も知りたくもないのさ～": "約束したのだ～",
            "秘密": "宇宙が～ふたりきり食べたおにぎりの～", "リリ": "君の青い髪が僕のイノセンスだった",
            "ナナ\nあなたは金色のシャンデリー": "ナナ…！", "彗星になれたなら": "夢のように愛して～\n愛のように夢をみて～",
            "夜魔": "普通に笑って普通に泣いて生きてみたかった～", "再会": "さんざめくこの世界にさよならを～",
            "手を繋いだまななら～": "二度と～", "来ない～": "さいか～～～～～～～～～～い！",
            "誕生": "翠の星に乗って～", "もう丸一日ふたりだけ…": "ちょっとさみしいね…",
            "……リリがいるだけで嬉しいよ…": "うん…私も……", "翠の星に乗って～": "あの日のふたりを見に行こう～",
            "やめたほうがいいのに～": "大人達は笑うけど～", "藍の鐘で": "また会おう",
        ...
        if len(content) >= 100: await message.reply("長すぎるよ～")
            ...
            simple = {
                "スープ": "そのスープ温かいうちに飲むのがいいよ", "知りたい": "ふたりのことが知りたいのなら～",
                "大人": "大人になれば～", "再会": "約束を", "おにぎり": "宇宙が～ふたりきり食べたおにぎりの～",
                "宇宙": "宇宙が～ふたりきり食べたおにぎりの～", "信じ": "信じていいと思った～\n信じていいと思った～",
                "イノセンス": "ボロボロになったイノセンスで～\n僕を認めてよ…", "夕焼け": "夕焼けに～染まったなら～\n息を止めてくれ",
                "本": "その本が気になるならば読んでもいいよ", "銀河": "遥か遠い銀河のなんでもない話だ",
                "瞳": "ただこの冷めた瞳を溶かすのは～\n君のイノセンスが僕を知る時だ～", "邪魔": "例えば誰かが僕らの邪魔をしていて",
                "例えば": "例えば\n僕らが\n例えば\n僕らが\n例えば\n例えば\n例えば\n例えば", "馬鹿": "あの日大人のふりして逃げた馬鹿な僕を～～\n許して欲しかった～～"
            }
...
class NanaBot(commands.Bot):
    ...
    async def setup_hook(self):
        NANA_COMMANDS = {
            "hello": "こんにちは～", "good_night": "みんなおやすみ～！", "good_morning": "おはよう～",
            "go_to_bed": "まだ寝てないの～？", "nice_picture": "すごいきれい…", "bye": "さよなら～またね～",
            "turn_off": "えぇ………", "sad": "やめてよ…！", "happy": "いえーい！", "angry": "ちょっと！",
            "feel_shy": "てへへへ…", "surprised": "うわっ！！", "sorry": "ごめんね…", "smile": "ふふふ～",
...
async def on_message(message):
    ...
    if message.author.id == LILI_USER_ID:
        responses = {
            ...
            "約束したのだ～": "流れ星の下で…", "宇宙が～ふたりきり食べたおにぎりの～": "海苔とかならいいのにね～～",
            "君の青い髪が僕のイノセンスだった": "リリ…！", "さんざめくこの世界にさよならを～": "手を繋いだまななら～",
            "二度と～": "来ない～", "翠の星に乗って～": "ふたりは一つの愛になる～",
            "……だれもいないの？": "もう丸一日ふたりだけ…", "ちょっとさみしいね…": "……リリがいるだけで嬉しいよ…",
            "大人になれば～": "全部忘れられると思うけど…", "約束を": "果たそう", "冒険しよう～": "ふ～たりは～",
        ...
        if len(content) >= 100: await message.reply(f"{len(content)}文字もあるよ～")
            ...
            if content == "ふたりの": await message.reply(random.choice(["ふたりの", "約束", "秘密", "彗星", "夜魔", "リリ", "再会"]))
